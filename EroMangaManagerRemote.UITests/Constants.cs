namespace EroMangaManagerRemote.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5000/";
    public readonly static string iOSAppName = "djdqfff.EroMangaManagerRemote";
    public readonly static string AndroidAppName = "djdqfff.EroMangaManagerRemote";
