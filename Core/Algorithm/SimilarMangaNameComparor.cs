...
public class SimilarNameComparor(IEnumerable<Manga> _books)
{
    private readonly List<Manga> books = [.. _books];
    ...
    public void CompareByName()
    {
        ...
        list1.Sort((x, y) => x.Name.Length - y.Name.Length);
        list1.ForEach(x => Console.WriteLine(x.Name));
